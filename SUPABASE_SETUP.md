...
2. Project URL과 anon key를 [supabase-config.js](</Users/GA/Documents/New project/apex 테스트/supabase-config.js>) 에 넣습니다.
3. 페이지에서 테스트를 완료하면 결과가 `apex_test_results` 테이블에 자동 저장됩니다.
